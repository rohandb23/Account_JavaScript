...
let a = User.newAdmin("rohan", "M", "IND")
let u1 = a.newUser("sarvesh", "M", "IND")
//let u2 = u1.newUser("omkar", "M", "IND")
// console.log(a);
// console.log(u1);
// console.log(u2);

//console.log(a.findUser("rohan"));
// let u3 = a.newUser("hemant", "M", "IND")

u1.createContact("omkar")
u1.createContact("hemant")

// u1.createContact("hemant")
// console.log(u1.getAllContact());

// u1.createContactInfo(0, "mobile", 7738530483)
// u1.createContactInfo(0, "email", "rohandbhise@gmail.com")
// console.log(u1.getAllContact());
